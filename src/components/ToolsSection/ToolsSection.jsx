    ...
    return (
        <section className="bg-black text-white py-16 px-4 overflow-x-hidden">
            <div className="max-w-7xl mx-auto">
                ...
                className="text-4xl font-bold text-orange-500 mb-8">Tools</motion.h2>
                <motion.h1
                initial={{scale:0.85, opacity:0}}
                whileInView={{scale:1, opacity:1}}
                transition={{duration:0.5,ease:"easeInOut"}}
                className="text-2xl md:text-3xl lg:text-5xl font-bold mb-12">THE KEY DESIGN AND DEVELOPMENT TOOLS I USE</motion.h1>
